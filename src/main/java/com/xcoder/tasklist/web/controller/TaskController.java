...
import com.xcoder.tasklist.web.mapper.TaskImageMapper;
...
public class TaskController {
    ...
    @PreAuthorize("@customerSecurityExpression.canAccessTask(#dto.id)")
    ...
    @PreAuthorize("@customerSecurityExpression.canAccessTask(#id)")
